...
class UIControlThemeMgt {
    ...
    static func setupLikeControl(like: WallFooterView, likeCount: UILabel, message: WallFooterView, eye: WallFooterView, share: WallFooterView, messageCount: UILabel, eyeCount: UILabel, shareCount: UILabel) {
        ...
        likeCount.textColor = ColorSystemHelper.isDark ? ColorSystemHelper.secondary : ColorSystemHelper.primary
        messageCount.textColor = ColorSystemHelper.isDark ? ColorSystemHelper.secondary : ColorSystemHelper.primary
        eyeCount.textColor = ColorSystemHelper.isDark ? ColorSystemHelper.secondary : ColorSystemHelper.primary
        shareCount.textColor = ColorSystemHelper.isDark ? ColorSystemHelper.secondary : ColorSystemHelper.primary
    ...
    static func renderImage(imageView: UIImageView){
        if let image = imageView.image {
            ...
            imageView.tintColor = ColorSystemHelper.isDark ? ColorSystemHelper.secondary : ColorSystemHelper.primary
        }
    }
    ...
    static func setupSearchControl(vc: UIViewController, searchController: UISearchController){
        ...
        searchController.searchBar.tintColor = ColorSystemHelper.isDark ? .white : ColorSystemHelper.primary
