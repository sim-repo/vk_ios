...
class ColorSystemHelper {
    ...
    static func setupLight() {
        ...
        let primary_color = #colorLiteral(red: 0.09332557768, green: 0.09781167656, blue: 0.1363540888, alpha: 1)
        let secondary_color = #colorLiteral(red: 0, green: 1, blue: 0.9725542665, alpha: 1)
        onPrimary = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
