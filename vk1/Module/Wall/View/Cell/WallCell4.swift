...
class WallCell4: BaseWall {
    ...
    lazy var buttons = [imageButton1!, imageButton2!, imageButton3!, imageButton4!]
    lazy var imageViews = [imageView1!, imageView2!, imageView3!, imageView4!]
...
extension WallCell4: ChildWallCellProtocol {
...
extension WallCell4: WallCellProtocol {
