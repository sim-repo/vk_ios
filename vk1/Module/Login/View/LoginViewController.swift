...
class LoginViewController: UIViewController, Storyboarded {
    ...
    private func checkPresenter() {
        if presenter == nil {
            fatalError("LoginViewController: checkPresenter(): presenter is nil")
        }
    }
...
//MARK: - PresentableLoginViewProtocol

extension LoginViewController: PresentableLoginViewProtocol {
...
//MARK: - CoordinatableLoginViewProtocol

extension LoginViewController: CoordinatableLoginViewProtocol {
